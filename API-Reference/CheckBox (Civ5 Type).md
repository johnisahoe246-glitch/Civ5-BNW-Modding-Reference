...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of CheckBox.<br/>
...
|width="100%" |<code>{{FuncLabel5|UIElement|GetTextButton}}<b>(</b><!-- No arguments --><b>)</b></code>
<!-- 
ISCHECKED
-->
|-
...
|width="100%" |<code>{{FuncLabel5|UIElement|IsChecked}}<b>(</b><!-- No arguments --><b>)</b></code>
|}
...
=Source code samples=
''Too many occurences. Only 10 out of 143 are listed.''

{{PseudoH4|DebugMode.xml}}
:<code>UI/InGame/DebugMode.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0208}}<syntaxhighlight lang="xml"><CheckBox Anchor="L,C"  ID="UnitSpecRenderDiffuse_Checkbox" Void1="1"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0007}}<syntaxhighlight lang="xml"><CheckBox String="Terrain"       Anchor="R,C"  TextAnchor="R,C" ID="TerrainToggle" Void2="1" IsChecked="1"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0009}}<syntaxhighlight lang="xml"><CheckBox String="Cities"       Anchor="R,C"  TextAnchor="R,C" ID="CityToggle" Void2="3" IsChecked="1"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0214}}<syntaxhighlight lang="xml"><CheckBox ButtonTexture="assets/UI/Art/Controls/CheckBox2TheBox.dds" TextAnchorSide="Right" Font="TwCenMT20" TextOffset="40,0" IsChecked="0" ID="ShowDLCMods" String="TXT_KEYMODDING_SHOWDLCMODS" ConsumeMouse="1"  /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0039}}<syntaxhighlight lang="xml"><CheckBox Anchor="L,T"  TextAnchorSide="Right" Offset="0,0" TextOffset="40,0" IsChecked="0" ID="ShowResources" String="TXT_KEY_MAP_OPTIONS_RESOURCE_ICONS" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0101}}<syntaxhighlight lang="xml"><CheckBox String="TXT_KEY_OPSCREEN_SPLAYER_QUICK_COMBAT" LeadingOffset="-10" WrapWidth="350" Anchor="R,C" ID="SPQuickCombatCheckBox" ToolTip="TXT_KEY_OPSCREEN_SPLAYER_QUICK_COMBAT_TT" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0113}}<syntaxhighlight lang="xml"><CheckBox String="TXT_KEY_OPSCREEN_CIVILIAN_YIELDS" LeadingOffset="-10" WrapWidth="350" Anchor="R,C" ID="CivilianYieldsCheckbox" ToolTip="TXT_KEY_OPSCREEN_CIVILIAN_YIELDS_TT"  /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0150}}<syntaxhighlight lang="xml"><CheckBox Anchor="R,C" String="TXT_KEY_OPSCREEN_AUTOSIZE_UI" IsChecked="1" ID="AutoUIAssetsCheck" ToolTip="TXT_KEY_OPSCREEN_AUTOSIZE_UI_TT" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|ReplayViewer.xml}}
:<code>UI/InGame/Popups/ReplayViewer.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0039}}<syntaxhighlight lang="xml"><CheckBox ButtonTexture="assets/UI/Art/Controls/CheckBox.dds" Anchor="R,C" Offset="5,0" TextOffset="40,0" IsChecked="1" ID="ShowHide" ConsumeMouse="1"  /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0079}}<syntaxhighlight lang="xml"><CheckBox  Anchor="R,T" Offset="6,3" ID="EnableCheck"  ToolTip="TXT_KEY_MP_DISABLE_SLOT" /></syntaxhighlight>
{{CodeEnd5}}
