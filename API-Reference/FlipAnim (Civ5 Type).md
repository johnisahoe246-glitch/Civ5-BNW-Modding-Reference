...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of FlipAnim.<br/>
...
|width="100%" |<code>{{FuncLabel5|UIElement|SetFrame}}<!-- No arguments --></code>
|}
...
=Source code samples=
''Too many occurences. Only 10 out of 50 are listed.''

{{PseudoH4|CityView_small.xml}}
:<code>UI/InGame/CityView/CityView_small.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0282}}<syntaxhighlight lang="xml"><FlipAnim Size="64,64" Offset="3,0" Columns="15" Anchor="C,C" Speed="20" Pause="-2" StepSize="64,0" FrameCount="15" Texture="assets\UI\Art\Notification\NotificationTilePurchaseAni.dds"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0320}}<syntaxhighlight lang="xml"><FlipAnim Size="64,64" Offset="3,0" Columns="15" Anchor="C,C" Speed="20"  EndPause="2" StepSize="64,0" FrameCount="15" Texture="assets\UI\Art\Notification\NotificationTilePurchaseAni.dds" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0829}}<syntaxhighlight lang="xml"><FlipAnim Size="64,64" Offset="0,6" Anchor="C,C" Columns="8" Speed="20" Pause=".5" StepSize="64,64" FrameCount="31" Texture="assets\UI\Art\Notification\CapitalAnimation.dds" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0857}}<syntaxhighlight lang="xml"><FlipAnim Size="64,64" Offset="0,6" Anchor="C,C" Columns="8" Speed="20" Pause=".5" StepSize="64,64" FrameCount="31" Texture="assets\UI\Art\Notification\capitollost.dds" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0910}}<syntaxhighlight lang="xml"><FlipAnim Size="64,64" Offset="0,0" Anchor="C,C" Columns="8" Speed="12" Pause="0" StepSize="64,64" FrameCount="30"  Texture="assets\UI\Art\Notification\Diplomacy.dds" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0999}}<syntaxhighlight lang="xml"><FlipAnim Size="64,64" Offset="0,0" Anchor="C,C" Columns="8" Speed="17" Pause="0" StepSize="64,64" FrameCount="32"  Texture="assets\UI\Art\Notification\Diplomacy_X.dds" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0124}}<syntaxhighlight lang="xml"><FlipAnim Size="64,64" Offset="0,0" Anchor="C,C" Columns="8" Speed="20" Pause="0" StepSize="64,64" FrameCount="31" Texture="assets\UI\Art\Notification\UnitAttackAnimation.dds"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0571}}<syntaxhighlight lang="xml"><FlipAnim Size="64,64" Offset="0,0" Anchor="L,B" Columns="4" Speed="10" Pause=".5" StepSize="64,64" FrameCount="8" Texture="assets\UI\Art\Notification\PromotionAnimation.dds"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0877}}<syntaxhighlight lang="xml"><FlipAnim Size="64,64" Offset="0,0" Anchor="C,C" Columns="8" Speed="17" Pause="0" StepSize="64,64" FrameCount="32" Texture="assets\UI\Art\Notification\Diplomacy_X.dds"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0029}}<syntaxhighlight lang="xml"><FlipAnim Size="64,64" Offset="12,-12" Anchor="L,T" Columns="4" Speed="10" Pause=".5" StepSize="64,64" FrameCount="8" Texture="assets\UI\Art\Notification\PromotionAnimation.dds" ID="PromotionAnimation" /></syntaxhighlight>
{{CodeEnd5}}
