...
=Source code samples=
''Too many occurences. Only 10 out of 325 are listed.''

{{PseudoH4|AdvancedSetup.xml}}
:<code>UI/FrontEnd/GameSetup/AdvancedSetup.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0006}}<syntaxhighlight lang="xml"><Container Size="380,68" ID="Root" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0679}}<syntaxhighlight lang="xml"><Container Anchor="R,C" Size="80,80" Offset="0,0"  Hidden="0" ID="UnitDiedContainer" ConsumeMouseButton="1" ></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0953}}<syntaxhighlight lang="xml"><Container Anchor="R,C" Size="80,80" Offset="0,0"  Hidden="0" ID="DiplomacyCheckContainer" ConsumeMouseButton="1" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0205}}<syntaxhighlight lang="xml"><Container Anchor="R,C" Size="80,80" Offset="0,0" Hidden="0" ID="ReligionEnhancedContainer" ConsumeMouseButton="1"></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0411}}<syntaxhighlight lang="xml"><Container Anchor="R,C" Size="80,80" Offset="0,0" Hidden="0" ID="WonderConstructedContainer" ConsumeMouseButton="1"></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0846}}<syntaxhighlight lang="xml"><Container Anchor="R,C" Size="80,80" Offset="0,0" Hidden="0" ID="DiplomacyCheckContainer" ConsumeMouseButton="1"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0024}}<syntaxhighlight lang="xml"><Container Anchor="C,C" ID="PreGameScreenUI"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0012}}<syntaxhighlight lang="xml"><Container Anchor="L,T" Size="270,70" ID="TechButtonContainer" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0007}}<syntaxhighlight lang="xml"><Container ID="MilitaryFlags" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|YieldIconManager.xml}}
:<code>UI/InGame/YieldIconManager.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0020}}<syntaxhighlight lang="xml"><Container ID="YieldStore" /></syntaxhighlight>
{{CodeEnd5}}
