...
=Usage=
<code>'''void''' PreGame.SetCivilizationDescription<b>(</b>{{Type5|PlayerID}} EditSlot, '''string''' arg1<b>)</b></code>
...
:{{CodeBegin5}}
{{CodeLine5|1127}}<syntaxhighlight lang="lua">PreGame.SetCivilizationDescription( 0, "");</syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0072}}<syntaxhighlight lang="lua">PreGame.SetCivilizationDescription( 0, "" );</syntaxhighlight>
{{CodeEnd5}}
...
{{CodeBreak5}}
{{CodeLine5|1234}}<syntaxhighlight lang="lua">PreGame.SetCivilizationDescription( playerID, "" );</syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Methods and Functions|SetCivilizationDescription]]
[[Category:Civ5 Players API|SetCivilizationDescription]]