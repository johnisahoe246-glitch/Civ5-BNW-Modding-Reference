...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of GridButton.<br/>
...
:{{CodeBegin5}}
{{CodeLine5|1261}}<syntaxhighlight lang="xml"><GridButton Style="BaseButton"  ID="OK" Size="400,42" Anchor="C,T" Offset="0,0"  Hidden="0"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0109}}<syntaxhighlight lang="xml"><GridButton ID="ThemPocketCities" Hidden="1" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0061}}<syntaxhighlight lang="xml"><GridButton Anchor="R,T"  Style="SmallButton" Size="110,32"  Offset="10,5" StateOffsetIncrement="0,0" ID="OptionsButton" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0093}}<syntaxhighlight lang="xml"><GridButton Anchor="L,T" Size="64,30" ID="ShadowRes2048" Style="BaseButton" ></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0261}}<syntaxhighlight lang="xml"><GridButton Anchor="R,Top" Size="110,30" ID="REQUEST" Style="BaseButton" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0109}}<syntaxhighlight lang="xml"><GridButton  Anchor="L,T" Size="100,28" Offset="0,-1"  Style="ZoomButton" ID="SortbyDLCHosted"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|MultiplayerSelect.xml}}
:<code>UI/FrontEnd/Multiplayer/MultiplayerSelect.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0071}}<syntaxhighlight lang="xml"><GridButton Anchor="C,T" ID="ReconnectButton"  Size="320,45"    Style="ZoomButton"  String="TXT_KEY_MULTIPLAYER_RECONNECT" Hidden="1" Disabled="true"  ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0179}}<syntaxhighlight lang="xml"><GridButton Anchor="C,B" Size="200,32" Offset="0,20" ID="ApplyResButton" Style="SmallButton" ToolTip="TXT_KEY_OPSCREEN_APPLY_RESOLUTION_TT"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0054}}<syntaxhighlight lang="xml"><GridButton Anchor="L,B" Style="SmallButton" Size="150,32" Offset="14,0" StateOffsetIncrement="0,0" ID="CloseButton"></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0448}}<syntaxhighlight lang="xml"><GridButton Size="170,36" Anchor="C,T" Offset="0,46" Font="TwCenMT18" Color="255,255,255,200" String="" FontStyle="Shadow" Color0="Beige.255" Color1="Black.128" Style="BaseButton" ToolTip="TXT_KEY_POLICY_BRANCH_COMMERCE_HELP" Hidden="0" ID="BranchButton5"></syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Types|GridButton]]