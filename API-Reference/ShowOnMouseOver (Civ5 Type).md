...
=New Properties=
{{PseudoH4|HideOnMouseOver}}
:Format: Unknown.
:Usage: Unknown.


{{PseudoH4|ShowOnMouseOver}}
:Format: Unknown.
:Usage: Unknown.
...
:{{CodeBegin5}}
{{CodeLine5|0007}}<syntaxhighlight lang="xml"><ShowOnMouseOver></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0090}}<syntaxhighlight lang="xml"><HideOnMouseOver></syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Types|ShowOnMouseOver]]