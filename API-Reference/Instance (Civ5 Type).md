...
=Source code samples=
''Too many occurences. Only 10 out of 518 are listed.''

{{PseudoH4|CityBannerManager.xml}}
:<code>UI/InGame/CityBannerManager.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0128}}<syntaxhighlight lang="xml"><Instance  Name="OtherCityBanner"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0057}}<syntaxhighlight lang="xml"><Instance Name="LeadsToTechInstance" ></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0222}}<syntaxhighlight lang="xml"><Instance Name="UnlockedProjectInstance" ></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0437}}<syntaxhighlight lang="xml"><Instance Name="TerrainInstance" ></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0469}}<syntaxhighlight lang="xml"><Instance Name="FreeFormTextInstance" ></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|GenericWorldAnchor.xml}}
:<code>UI/InGame/GenericWorldAnchor.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0012}}<syntaxhighlight lang="xml"><Instance Name="SettlerReccomendation" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0045}}<syntaxhighlight lang="xml"><Instance Name="DetailLabelInstance"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|1011}}<syntaxhighlight lang="xml"><Instance Name="NaturalWonderItem" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0768}}<syntaxhighlight lang="xml"><Instance Name="CapitalLostItem"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|Ranking.xml}}
:<code>UI/InGame/Popups/Ranking.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0027}}<syntaxhighlight lang="xml"><Instance Name="RankEntry" ></syntaxhighlight>
{{CodeEnd5}}
