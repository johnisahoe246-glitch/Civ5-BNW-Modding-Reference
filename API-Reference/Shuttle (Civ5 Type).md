...
:{{CodeBegin5}}
{{CodeLine5|0432}}<syntaxhighlight lang="xml"><Shuttle Style="Grid3Shuttle" Size="18,18" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0449}}<syntaxhighlight lang="xml"><Shuttle Style="Slider32" Size="32,32" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0465}}<syntaxhighlight lang="xml"><Shuttle Style="VertShuttle" Size="18,18" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0115}}<syntaxhighlight lang="xml"><Shuttle Style="Grid3Shuttle" Size="16,16" /></syntaxhighlight>
{{CodeEnd5}}
