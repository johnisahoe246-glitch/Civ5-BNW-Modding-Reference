...
=Usage=
<code>'''unknown''', '''unknown''' Matchmaking.HostInternetGame<b>(</b>'''string''' gameName, '''int''' arg1<b>)</b></code>
...
:{{CodeBegin5}}
{{CodeLine5|0049}}<syntaxhighlight lang="lua">local bResult, bPending = Matchmaking.HostInternetGame( strGameName, worldInfo.DefaultPlayers );</syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Methods and Functions|HostInternetGame]]