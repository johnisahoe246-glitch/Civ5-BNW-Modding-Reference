...
=Usage=
<code>{{Type5|ResourceType}} City:GetY<b>(</b><b>)</b></code>
...
:{{CodeBegin5}}
{{CodeLine5|0026}}<syntaxhighlight lang="lua">thisY = pHeadSelectedCity:GetY();</syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0110}}<syntaxhighlight lang="lua">local cityY = city:GetY();</syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0291}}<syntaxhighlight lang="lua">local thisY = pCapital:GetY();</syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0678}}<syntaxhighlight lang="lua">local iCityStateY = pCityStateCity:GetY();</syntaxhighlight>
{{CodeEnd5}}
...
{{CodeBreak5}}
{{CodeLine5|0429}}<syntaxhighlight lang="lua">local iY = pTargetCity:GetY();</syntaxhighlight>
{{CodeBreak5}}
