...
:{{CodeBegin5}}
{{CodeLine5|1238}}<syntaxhighlight lang="xml"><ToolTipType Name="TypeRoundImage" ></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|PlotHelpManager.xml}}
:<code>UI/InGame/PlotHelpManager.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0005}}<syntaxhighlight lang="xml"><ToolTipType Name="HexDetails" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0035}}<syntaxhighlight lang="xml"><ToolTipType Name="TooltipTypeTopPanel" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0196}}<syntaxhighlight lang="xml"><ToolTipType Name="TypeUnitAction" ></syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Types|ToolTipType]]