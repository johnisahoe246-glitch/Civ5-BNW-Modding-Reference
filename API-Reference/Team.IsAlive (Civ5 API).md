...
=Usage=
<code>'''int''' Team:IsAlive<b>(</b><b>)</b></code>
...
{{CodeBreak5}}
{{CodeLine5|0703}}<syntaxhighlight lang="lua">if(v:IsAlive()) then</syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0214}}<syntaxhighlight lang="lua">if (pLoopTeam:IsAlive()) then</syntaxhighlight>
{{CodeEnd5}}
