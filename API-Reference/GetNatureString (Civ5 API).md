...
=Usage=
<code>'''string''' GetNatureString<b>(</b>{{Type5|Plot}} plot<b>)</b></code>
...
:{{CodeBegin5}}
{{CodeLine5|0222}}<syntaxhighlight lang="lua">local natureStr = GetNatureString(plot);</syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Methods and Functions|GetNatureString]]