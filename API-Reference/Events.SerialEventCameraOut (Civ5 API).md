...
=Usage=
<code>'''void''' Events.SerialEventCameraOut<b>(</b>{{Type5|Vector2}} arg0<b>)</b></code>


'''Event Type'''
:Regular event: you can subscribe to it through <code>Events.SerialEventCameraOut.Add(''<function handler>'')</code> or invoke it directly through <code>Events.SerialEventCameraOut(''<arguments list>'')</code>.
...
{{Civ5 API Footer}}
[[Category:Civ5 Methods and Functions|SerialEventCameraOut]]