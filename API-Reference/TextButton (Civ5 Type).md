...
{{PseudoH4|MouseOverStyle}}
:Format: Unknown.
:Usage: Unknown.


{{PseudoH4|NormalState}}
:Format: Unknown.
:Usage: Unknown.


=New Instance Methods=
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of TextButton.<br/>
...
=Source code samples=
''Too many occurences. Only 10 out of 144 are listed.''

{{PseudoH4|CityList.xml (G&K)}}
:<code>DLC/Expansion/UI/InGame/CityList.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0100}}<syntaxhighlight lang="xml"><TextButton Offset="0,22" Anchor="C,B" Font="TwCenMT14" ColorSet="Beige_Black_Alpha" String="TXT_KEY_CLOSE" ToolTip="TXT_KEY_CLOSE" FontStyle="Shadow" MouseOverStyle="SoftShadow" ConsumeMouse="1" ID="CloseButton" Hidden="0" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0137}}<syntaxhighlight lang="xml"><TextButton Anchor="R,B" AnchorSide="o,i" Offset="7,0" Font="TwCenMT22" String="[ICON_INFLUENCE]" ID="QuestIcon"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|EspionageOverview.xml (G&K)}}
:<code>DLC/Expansion/UI/InGame/Popups/EspionageOverview.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0252}}<syntaxhighlight lang="xml"><TextButton Offset="20,0" Anchor="L,B" Font="TwCenMT20" ColorSet="Beige_Black_Alpha" String="TXT_KEY_EO_NAME_RANK" FontStyle="Shadow" MouseOverStyle="SoftShadow" ConsumeMouse="1" ID="ASortByNameRank"></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0337}}<syntaxhighlight lang="xml"><TextButton Offset="0,0" Anchor="C,B" Font="TwCenMT20" ColorSet="Beige_Black_Alpha" ToolTip="TXT_KEY_EO_CIVILIZATION_SORT_TT" String="TXT_KEY_EO_CIVILIZATION" FontStyle="Shadow" MouseOverStyle="SoftShadow" ConsumeMouse="1" ID="YCSortByCivilization"></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0420}}<syntaxhighlight lang="xml"><TextButton Offset="0,0" Anchor="C,B" Font="TwCenMT20" ColorSet="Beige_Black_Alpha" String="TXT_KEY_EO_INTRIGUE_FROM" FontStyle="Shadow" MouseOverStyle="SoftShadow" ConsumeMouse="1" ID="IntrigueSortByFrom"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|GameMenu.xml}}
:<code>UI/InGame/Menus/GameMenu.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0174}}<syntaxhighlight lang="xml"><TextButton ID="ModsButton" Offset="6,0" Anchor="L,B" Font="TwCenMT14" ColorSet="Beige_Black_Alpha" String="Mods" FontStyle="Shadow" MouseOverStyle="SoftShadow" ConsumeMouse="1" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0269}}<syntaxhighlight lang="xml"><TextButton Offset="0,1" Anchor="C,C" Font="TwCenMT16" ColorSet="Beige_Black_Alpha" String="TXT_KEY_RO_B_TYPE" FontStyle="Shadow" MouseOverStyle="SoftShadow" ConsumeMouse="1" ID="BPSortbyType" Hidden="0" ></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|TopPanel.xml}}
:<code>UI/InGame/TopPanel.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0016}}<syntaxhighlight lang="xml"><TextButton Anchor="C,T" String="CULTURE!" ColorLayer0="255,255,200,255"  ID="CultureString" ToolTipType="TooltipTypeTopPanel"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0028}}<syntaxhighlight lang="xml"><TextButton Anchor="C,C"  String="TXT_KEY_HELP_CAPS"   Font="TwCenMT20" NormalState="Beige_Black"  MouseOver="White_Black" ButtonDown="Beige_Black_Alpha" ID="CivilopediaButton" ToolTip="TXT_KEY_CIVILOPEDIA_TOOLTIP" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|UnitPanel.xml}}
:<code>UI/InGame/WorldView/UnitPanel.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0099}}<syntaxhighlight lang="xml"><TextButton Anchor="R,C" String="000" ID="UnitStatStrength" Offset="10,-2"  ToolTip="TXT_KEY_UPANEL_STRENGTH_TT" /></syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Types|TextButton]]