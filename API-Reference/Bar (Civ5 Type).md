...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of Bar.<br/>
...
|width="100%" |<code>{{FuncLabel5|UIElement|SetFGColor}}<b>(</b>{{Type5|Vector4}} tBarColor<b>)</b></code>
|}
...
=Source code samples=
''Too many occurences. Only 10 out of 45 are listed.''

{{PseudoH4|CityBannerManager.xml (G&K)}}
:<code>DLC/Expansion/UI/InGame/CityBannerManager.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0041}}<syntaxhighlight lang="xml"><Bar Anchor="C,B" Offset="0,0" Size="4,30" FGColor="Food,128" Hidden="0" ID="GrowthBarShadow" Direction="Up"/></syntaxhighlight>
{{CodeLine5|0042}}<syntaxhighlight lang="xml"><Bar Anchor="C,B" Offset="0,0" Size="4,30" FGColor="Food,255" Hidden="0" ID="GrowthBar" Direction="Up"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0049}}<syntaxhighlight lang="xml"><Bar Anchor="C,B" Offset="0,0" Size="4,30" FGColor="Production,128" Hidden="0" ID="ProductionBarShadow" Direction="Up"/></syntaxhighlight>
{{CodeLine5|0050}}<syntaxhighlight lang="xml"><Bar Anchor="C,B" Offset="0,0" Size="4,30" FGColor="Production,255" Hidden="0" ID="ProductionBar" Direction="Up"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0075}}<syntaxhighlight lang="xml"><Bar Anchor="C,C" Offset="0,0" Size="98,3" Direction="Right" FGColor="Green,255" ID="CityBannerHealthBar" Hidden="0"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|CityList.xml}}
:<code>UI/InGame/CityList.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0173}}<syntaxhighlight lang="xml"><Bar Anchor="C,C" Offset="0,0" Size="138,3" Direction="Right" FGColor="Green,255" ID="HealthBar" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|GPList.xml (G&K)}}
:<code>DLC/Expansion/UI/InGame/GPList.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0156}}<syntaxhighlight lang="xml"><Bar Anchor="L,T" Offset="1,2" Direction="R" Size="357,18" FGColor="0,255,0,100" ID="GGMeter"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0075}}<syntaxhighlight lang="xml"><Bar Anchor="C,B" Direction="L" Size="100,3" BGColor="0,0,0,255" FGColor="0,255,0,255" ID="Bar2"/></syntaxhighlight>
{{CodeLine5|0076}}<syntaxhighlight lang="xml"><Bar Anchor="L,C" Direction="U" Size="3,100" BGColor="0,0,0,255" FGColor="0,255,0,255" ID="Bar3"/></syntaxhighlight>
{{CodeLine5|0077}}<syntaxhighlight lang="xml"><Bar Anchor="R,C" Direction="D" Size="3,100" BGColor="0,0,0,255" FGColor="0,255,0,255" ID="Bar4"/></syntaxhighlight>
{{CodeEnd5}}
