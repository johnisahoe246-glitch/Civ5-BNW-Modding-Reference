...
:{{CodeBegin5}}
{{CodeLine5|0109}}<syntaxhighlight lang="xml"><UpButton Anchor="R,T" Offset="0.0" Style="ScrollBarUp"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0165}}<syntaxhighlight lang="xml"><UpButton  Offset="7.2"  Style="ScrollBarUp"  Anchor="L,T" AnchorSide="O,I" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|EconomicGeneralInfo.xml}}
:<code>UI/InGame/Popups/EconomicGeneralInfo.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0197}}<syntaxhighlight lang="xml"><UpButton   Offset="0,0"    Style="ScrollBarUp"     Anchor="R,T"                   ID="UpButton"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0079}}<syntaxhighlight lang="xml"><UpButton Offset="8,2" Style="ScrollBarUp" Anchor="R,T" AnchorSide="o,i"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0134}}<syntaxhighlight lang="xml"><UpButton Offset="-222,0" Style="ScrollBarUp" Anchor="l,T" ID="UpButton" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0062}}<syntaxhighlight lang="xml"><UpButton  Offset="0.0"  Style="ScrollBarUp"  Anchor="R,T" AnchorSide="O,I" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0038}}<syntaxhighlight lang="xml"><UpButton   Anchor="R,T" AnchorSide="O,I" Offset="0,0" Style="ScrollBarUp"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0236}}<syntaxhighlight lang="xml"><UpButton   Style="ScrollBarUp"   Anchor="R,T" AnchorSide="O,I" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0064}}<syntaxhighlight lang="xml"><UpButton   Style="Button_16" Anchor="L,T" AnchorSide="i,o" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0129}}<syntaxhighlight lang="xml"><UpButton  Offset="-222,0"  Style="ScrollBarUp"  Anchor="l,T" ID="UpButton"/></syntaxhighlight>
{{CodeEnd5}}
