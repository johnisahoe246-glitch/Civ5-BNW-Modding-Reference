...
:{{CodeBegin5}}
{{CodeLine5|0057}}<syntaxhighlight lang="xml"><Meter Size="100,100" Texture="assets\UI\Art\WorldView\TimerMeter.dds" HasShadow="1" Color="White.255" ShadowColor="0,0,0,100" ID="EndTurnTimeMeter" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0115}}<syntaxhighlight lang="xml"><Meter Anchor="L,B" Size="256,256" Texture="assets\UI\Art\WorldView\ProductionPanelMeter.dds" HasShadow="1" ID="ProductionMeter"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0125}}<syntaxhighlight lang="xml"><Meter Anchor="L,B" Size="128,128" Texture="ProductionPanelMeter128.dds" HasShadow="1" ID="ProductionMeter"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0402}}<syntaxhighlight lang="xml"><Meter Anchor="C,C" Size="128,128" Texture="TechGold1024Frame.dds" HasShadow="1" ID="GrowthMeter"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0049}}<syntaxhighlight lang="xml"><Meter Anchor="C,C"  Size="220,220" Texture="assets\UI\Art\WorldView\TechPanelMeter.dds" HasShadow="1" Color="255,255,255,255" ShadowColor="255,255,255,100" ID="ResearchMeter" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|TechPanel_small.xml}}
:<code>UI/InGame/TechPanel_small.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0071}}<syntaxhighlight lang="xml"><Meter Anchor="C,C" Size="128.128" Texture="TechTreeMeter.dds" HasShadow="1" Color="255,255,255,255" ShadowColor="255,255,255,100" ID="ResearchMeter"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0099}}<syntaxhighlight lang="xml"><Meter Anchor="C,C" Size="0.0" Texture="TechTreeMeter.dds" HasShadow="0" Color="255,255,255,0" ShadowColor="255,255,255,0" ID="ProgressMeterInternal"/></syntaxhighlight>
{{CodeEnd5}}
