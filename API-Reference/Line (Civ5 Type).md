...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of Line.<br/>
...
|width="100%" |<code>{{FuncLabel5|UIElement|SetEndVal}}<b>(</b>'''int''' newX, '''int''' newY<b>)</b></code>
<!-- 
SETSTARTVAL
-->
|-
{{FuncInfos5|yes  |yes  |no |<!-- No comment -->}}
|align="right"  |<code><!-- No return type --></code>
|width="100%" |<code>{{FuncLabel5|UIElement|SetStartVal}}<b>(</b>'''int''' startX, '''int''' startY<b>)</b></code>
|}
...
=Source code samples=
''Too many occurences. Only 10 out of 140 are listed.''

{{PseudoH4|ReplayViewer.xml}}
:<code>UI/InGame/Popups/ReplayViewer.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0037}}<syntaxhighlight lang="xml"><Line Color="0,255,255,120" Start="40,8" End="110,8" Width="2" ID="LegendLine"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0108}}<syntaxhighlight lang="xml"><Line Color="255,255,200,255" Start="72,360" End="72,365" Width="1" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0112}}<syntaxhighlight lang="xml"><Line Color="255,255,200,255" Start="144,360" End="144,365" Width="1" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0123}}<syntaxhighlight lang="xml"><Line Color="255,255,200,255" Start="252,360" End="252,365" Width="1" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0130}}<syntaxhighlight lang="xml"><Line Color="255,255,200,255" Start="360,360" End="360,370" Width="1" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0141}}<syntaxhighlight lang="xml"><Line Color="255,255,200,255" Start="486,360" End="486,365" Width="1" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0152}}<syntaxhighlight lang="xml"><Line Color="255,255,200,255" Start="594,360" End="594,365" Width="1" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0171}}<syntaxhighlight lang="xml"><Line Color="255,255,200,255" Start="720,18" End="725,18" Width="1" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0173}}<syntaxhighlight lang="xml"><Line Color="255,255,200,255" Start="720,54" End="725,54" Width="1" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0201}}<syntaxhighlight lang="xml"><Line Color="255,255,200,255" Start="720,288" End="725,288" Width="1" /></syntaxhighlight>
{{CodeEnd5}}
