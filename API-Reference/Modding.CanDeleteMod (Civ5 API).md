...
=Usage=
<code>'''bool''' Modding.CanDeleteMod<b>(</b>'''unknown''' modId, '''int''' modVersion<b>)</b></code>
...
:{{CodeBegin5}}
{{CodeLine5|0741}}<syntaxhighlight lang="lua">local bCanDeleteMod = Modding.CanDeleteMod(modId, modVersion);</syntaxhighlight>
{{CodeBreak5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Methods and Functions|CanDeleteMod]]