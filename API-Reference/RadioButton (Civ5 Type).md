...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of RadioButton.<br/>
...
=Source code samples=
''Too many occurences. Only 10 out of 74 are listed.''

{{PseudoH4|CityView.xml}}
:<code>UI/InGame/CityView/CityView.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0349}}<syntaxhighlight lang="xml"><RadioButton ID="BalancedFocusButton" String="TXT_KEY_CITYVIEW_FOCUS_BALANCED_TEXT" ButtonTexture="Assets/UI/Art/Controls/CheckBox.dds" Font="TwCenMT16" FontStyle="Shadow" ColorLayer0="Beige" ColorLayer1="Black" TextAnchor="R,C" TextAnchorSide="O,O" IsChecked="1" RadioGroup="FocusGroup" ToolTip="TXT_KEY_CITYVIEW_FOCUS_BALANCED_TT"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0361}}<syntaxhighlight lang="xml"><RadioButton ID="GPFocusButton" String="TXT_KEY_CITYVIEW_FOCUS_GREAT_PERSON_TEXT" ButtonTexture="Assets/UI/Art/Controls/CheckBox.dds" Font="TwCenMT16" FontStyle="Shadow" ColorLayer0="Beige" ColorLayer1="Black" TextAnchor="R,C" TextAnchorSide="O,O" IsChecked="0" RadioGroup="FocusGroup" ToolTip="TXT_KEY_CITYVIEW_FOCUS_GREAT_PERSON_TT"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0007}}<syntaxhighlight lang="xml"><RadioButton String="Default Mode"      ID="DefaultMode_Button" Void2="0" TextAnchor="R,C" TextAnchorSide="O,O" IsChecked="1" RadioGroup="one" /></syntaxhighlight>
{{CodeLine5|0008}}<syntaxhighlight lang="xml"><RadioButton String="Create City"      ID="CreateCity_Button" Void2="1" TextAnchor="R,C" TextAnchorSide="O,O" IsChecked="0" RadioGroup="one" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|GraphicsPanel.xml}}
:<code>UI/InGame/GraphicsPanel.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0024}}<syntaxhighlight lang="xml"><RadioButton String="MIP Display Absolute" ID="DisplayRelMIP_Button" Void2="3" TextAnchor="R,C" TextAnchorSide="O,O" IsChecked="0" RadioGroup="one" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|HexDebugTextPanel.xml}}
:<code>UI/InGame/HexDebugTextPanel.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0010}}<syntaxhighlight lang="xml"><RadioButton String="Tactical Analysis" ID="HexDebug_WorkerPriority_Button" Void2="4" TextAnchor="R,C" TextAnchorSide="O,O" IsChecked="0" RadioGroup="one"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0012}}<syntaxhighlight lang="xml"><RadioButton String="Revealed" ID="HexDebug_Revealed_Button" Void2="6" TextAnchor="R,C" TextAnchorSide="O,O" IsChecked="0" RadioGroup="one"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|PreGameScreen.xml}}
:<code>UI/FrontEnd/PreGameScreen.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0033}}<syntaxhighlight lang="xml"><RadioButton String="TXT_KEY_PGSCREEN_FRACTAL" ButtonTexture="Assets/UI/Art/Controls/CheckBox.dds" ColorLayer0="Beige" ColorLayer1="Black" TextAnchor="R,C" TextAnchorSide="O,O" IsChecked="1" RadioGroup="mapselect" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0048}}<syntaxhighlight lang="xml"><RadioButton String="TXT_KEY_PGSCREEN_SPEED_QUICK" ButtonTexture="Assets/UI/Art/Controls/CheckBox.dds" ColorLayer0="Beige" ColorLayer1="Black" TextAnchor="R,C" TextAnchorSide="O,O" IsChecked="0" RadioGroup="speedselect" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0030}}<syntaxhighlight lang="xml"><RadioButton String="Radio2" ColorLayer0="Beige" ColorLayer1="Black" TextAnchor="C,B" TextAnchorSide="O,O" IsChecked="1" RadioGroup="one" /></syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Types|RadioButton]]