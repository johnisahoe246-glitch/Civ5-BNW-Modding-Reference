...
=Source code samples=
''Too many occurences. Only 10 out of 248 are listed.''

{{PseudoH4|AdvisorInfoPopup.xml}}
:<code>UI/InGame/Popups/AdvisorInfoPopup.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0060}}<syntaxhighlight lang="xml"><DownButton Style="ScrollBarDown"  Offset="0,0" Anchor="R,B" AnchorSide="O,I" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0080}}<syntaxhighlight lang="xml"><DownButton Anchor="R,B" Offset="0.0" Style="ScrollBarDown"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0218}}<syntaxhighlight lang="xml"><DownButton Offset="0.312" Style="ScrollBarDown"  Anchor="R,T" AnchorSide="I,I" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|GPList.xml}}
:<code>UI/InGame/GPList.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0135}}<syntaxhighlight lang="xml"><DownButton Offset="-222,261" Style="ScrollBarDown" Anchor="l,T" ID="DownButton" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0063}}<syntaxhighlight lang="xml"><DownButton Offset="0.0" Style="ScrollBarDown"  Anchor="R,B" AnchorSide="O,I" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0011}}<syntaxhighlight lang="xml"><DownButton Offset="0,0" Style="ScrollBarDown"   Anchor="R,B"   AnchorSide="o,i"    ID="DownButton"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|PremiumContentMenu.xml}}
:<code>UI/FrontEnd/PremiumContentMenu.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0039}}<syntaxhighlight lang="xml"><DownButton Anchor="R,B" AnchorSide="O,I" Offset="0,0" Style="ScrollBarDown"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0088}}<syntaxhighlight lang="xml"><DownButton Offset="0,360" Style="ScrollBarDown"  Anchor="R,T" AnchorSide="I,I" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0085}}<syntaxhighlight lang="xml"><DownButton Offset="-4,-3" Style="ScrollBarDown" Anchor="R,B" AnchorSide="I,I"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0055}}<syntaxhighlight lang="xml"><DownButton Style="Button_16"  Anchor="R,B" AnchorSide="o,i" /></syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Types|DownButton]]