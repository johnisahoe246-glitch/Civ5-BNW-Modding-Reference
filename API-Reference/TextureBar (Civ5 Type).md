...
=Source code samples=
''Too many occurences. Only 10 out of 63 are listed.''

{{PseudoH4|CityBannerManager.xml (G&K)}}
:<code>DLC/Expansion/UI/InGame/CityBannerManager.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0135}}<syntaxhighlight lang="xml"><TextureBar ID="NegativeStatusMeter" Anchor="L,C" Size="81.7" Direction="Left" Texture="Assets/UI/Art/Notification/CityStateMeterBaseRed.dds" Hidden="0"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0068}}<syntaxhighlight lang="xml"><TextureBar Anchor="C,C" Offset="0,-1" Size="46.52" Texture="assets\UI\Art\Icons\MeterBarCultureBorder.dds" Direction="Up" ID="CultureMeter" Hidden="0"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0211}}<syntaxhighlight lang="xml"><TextureBar Anchor="L,C" Size="214.29" Texture="MeterBarGreatPersonGold.dds" Direction="Right" ID="GPMeter" Hidden="0"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0239}}<syntaxhighlight lang="xml"><TextureBar ID="HealthMeter" Anchor="L,C" Size="278.10" Direction="Right" Texture="assets\UI\Art\WorldView\CityNamePanelHealthBarGreen.dds" Hidden="0" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0015}}<syntaxhighlight lang="xml"><TextureBar Anchor="C,C" Offset="-1,-1" Size="54.54" Texture="CitizenMeter54.dds" Direction="Up" ID="PeopleMeter" Hidden="0"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0133}}<syntaxhighlight lang="xml"><TextureBar Anchor="L,C" Size="93,20" Texture="Esp_CityPotential_Stars_Blue.dds" Direction="Right" ID="PotentialMeterGhost"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|LoadScreen.xml (G&K)}}
:<code>DLC/Expansion/UI/FrontEnd/LoadScreen.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0054}}<syntaxhighlight lang="xml"><TextureBar Anchor="C,C" Offset="0,0" Size="287.36" Texture="Assets/DLC/Expansion/UI/Art/Civilopedia/LoadingMeterHL.dds" Direction="Right" ID="ProgressBar" Hidden="0"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0060}}<syntaxhighlight lang="xml"><TextureBar Anchor="L,C" Size="214,29" Texture="MeterBarUtopia.dds" Direction="Right" ID="UtopiaBar"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0083}}<syntaxhighlight lang="xml"><TextureBar Anchor="L,T"  Offset="3,2"  Texture="assets/UI/Art/UnitPanel/XPmeter.dds" Size="269,7" ID="XPMeter"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0117}}<syntaxhighlight lang="xml"><TextureBar Anchor="C,C" Offset="0,0"  Size="46.45"  Texture="assets/UI/Art/UnitPanel/WorkerMeter.dds" Direction="Up" ID="WorkerProgressBar" Hidden="0" /></syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Types|TextureBar]]