...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of Stack.<br/>
...
=Source code samples=
''Too many occurences. Only 10 out of 1283 are listed.''

{{PseudoH4|1066ScenarioLoadScreen.xml - DLC_04 DLC}}
:<code>DLC/DLC_04/Scenarios/1066Scenario/1066ScenarioLoadScreen.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0146}}<syntaxhighlight lang="xml"><Stack Anchor="C,T" Offset="0,36" Size="128,128" StackGrowth="Bottom" Padding="12" ID="MainStack"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|DiploGlobalRelationships.xml}}
:<code>UI/InGame/Popups/DiploGlobalRelationships.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0050}}<syntaxhighlight lang="xml"><Stack Anchor="R,B" Offset="50,12" StackGrowth="Bottom" Padding="6" ID="OuterStack" ></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|DiploList.xml}}
:<code>UI/InGame/DiploList.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0140}}<syntaxhighlight lang="xml"><Stack Anchor="L,C" StackGrowth="Right" Offset="0,0" Padding="0" ID="LeaderStack"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0023}}<syntaxhighlight lang="xml"><Stack Size="116,20" Offset="0,20" Anchor="C,T" StackGrowth="Bottom" ID="AgentActivitiesStack"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|HappinessInfo.xml}}
:<code>UI/InGame/Popups/HappinessInfo.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0136}}<syntaxhighlight lang="xml"><Stack Growth="Bottom" Offset="0,0" ID="UnhappinessStack" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0161}}<syntaxhighlight lang="xml"><Stack   Anchor="L,B" Padding="5" StackGrowth="Right" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0204}}<syntaxhighlight lang="xml"><Stack Anchor="L,T" Offset="0,0"  StackGrowth="Bottom" Padding="4" ID="ReferencedPackagesStack" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0067}}<syntaxhighlight lang="xml"><Stack Anchor="L,T" Size="256,32" StackGrowth="B" Padding="0" ID="StackOStacks"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0069}}<syntaxhighlight lang="xml"><Stack Anchor="L,T" Offset="18,68" Padding="0" Size="0,0" StackGrowth="Bottom"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0435}}<syntaxhighlight lang="xml"><Stack ID="ScoreStack" Anchor="L.T" Offset="0,0" Padding="0" StackGrowth="Bottom"/></syntaxhighlight>
{{CodeEnd5}}
