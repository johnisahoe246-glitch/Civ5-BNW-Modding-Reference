...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of ScrollPanel.<br/>
...
|width="100%" |<code>{{FuncLabel5|UIElement|GetRatio}}<b>(</b><!-- No arguments --><b>)</b></code>
|}
...
=Source code samples=
''Too many occurences. Only 10 out of 271 are listed.''

{{PseudoH4|AdvisorModal.xml}}
:<code>UI/InGame/Popups/AdvisorModal.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0019}}<syntaxhighlight lang="xml"><ScrollPanel Anchor="C,B" AnchorSide="I.O" Vertical="1" Offset="0,12" Size="400,400" AutoScrollBar="1"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|CityView.xml (G&K)}}
:<code>DLC/Expansion/UI/InGame/CityView/CityView.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0306}}<syntaxhighlight lang="xml"><ScrollPanel Anchor="L,T" Offset="18,44" Size="272,500" Vertical="1" ID="ScrollPanel"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|DiploCurrentDeals.xml}}
:<code>UI/InGame/Popups/DiploCurrentDeals.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0102}}<syntaxhighlight lang="xml"><ScrollPanel ID="ThemPocketPanel" Hidden="1" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0220}}<syntaxhighlight lang="xml"><ScrollPanel Anchor="R,T" Offset="5,0" Size="210,400"  Vertical="1" ID="ThemTablePanel" AutoScrollBar="1" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0156}}<syntaxhighlight lang="xml"><ScrollPanel Anchor="L,T" Offset="200,29"  Size="724,474" Vertical="1" ID="ScrollPanel" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0027}}<syntaxhighlight lang="xml"><ScrollPanel Anchor="L,T" ID="OptionsScrollPanel" Vertical="1" Offset="40, 106" Size="884,344" AutoScrollBar="1"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|SelectMapSize.xml}}
:<code>UI/FrontEnd/GameSetup/SelectMapSize.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0034}}<syntaxhighlight lang="xml"><ScrollPanel Offset="0,32" Size="330,372" Vertical="1" ID="ScrollPanel" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0318}}<syntaxhighlight lang="xml"><ScrollPanel Anchor="C,T" Offset="0,86" Size="190,500" Vertical="1" ID="AutocracyPanel"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0013}}<syntaxhighlight lang="xml"><ScrollPanel Anchor="L,C" Size="Full,705" Vertical="0" ID="TechTreeScrollPanel"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|VictoryProgress.xml}}
:<code>UI/InGame/Popups/VictoryProgress.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0431}}<syntaxhighlight lang="xml"><ScrollPanel Anchor="L,T" Offset="0,32" Size="596,539" Vertical="1" ID="ScoreScrollPanel"></syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Types|ScrollPanel]]