...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of AlphaAnim.<br/>
...
=Source code samples=
''Too many occurences. Only 10 out of 1640 are listed.''

{{PseudoH4|CityBannerManager.xml}}
:<code>UI/InGame/CityBannerManager.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0225}}<syntaxhighlight lang="xml"><AlphaAnim Anchor="C,C" Size="48,48" Texture="Assets/UI/Art/Icons/CityBannerStrengthAlpha_Small.dds" ID="MouseOver" Sampler="Linear" Pause="0" Cycle="Bounce" Speed="2" AlphaStart="1" AlphaEnd="0"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0136}}<syntaxhighlight lang="xml"><AlphaAnim ID="WarAnim" Anchor="C,C" Offset="0,0" Size="500,35" Pause="0" Cycle="Bounce" Speed="1" AlphaStart="2" AlphaEnd="1"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|EnemyUnitPanel.xml}}
:<code>UI/InGame/WorldView/EnemyUnitPanel.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0077}}<syntaxhighlight lang="xml"><AlphaAnim   Anchor="C,C" Offset="0,0" Size="320,36" TextureOffset="0.0"  Pause="0" Cycle="Bounce" Speed="1" AlphaStart=".55" AlphaEnd=".99" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0556}}<syntaxhighlight lang="xml"><AlphaAnim  Anchor="R,C"  AnchorSide="O.O"  Offset="9,-1" Size="16,32" TextureOffset="16.0" Texture="Assets/UI/Art/Controls/buttonsidesglow.dds" Pause="0" Cycle="Bounce" Speed="1" AlphaStart=".99" AlphaEnd=".25" Hidden="0"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|InfoCorner.xml}}
:<code>UI/InGame/InfoCorner.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0021}}<syntaxhighlight lang="xml"><AlphaAnim Anchor="R,T" Offset="0,0" Size="45.45"  TextureOffset="0.0" Texture="assets\UI\Art\Icons\MainOpenHL.dds"  Pause="0" Cycle="Bounce" Speed="2" AlphaStart="0.95" AlphaEnd="0.55" ID="PDAlpha" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|MiniMapPanel.xml}}
:<code>UI/InGame/WorldView/MiniMapPanel.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0053}}<syntaxhighlight lang="xml"><AlphaAnim Anchor="C,C" Offset="0,0" Size="45.45"  TextureOffset="0.0" Texture="assets\UI\Art\Icons\MainStrategicButtonHL.dds" ID="StrategicHL"  Pause="0" Cycle="Bounce" Speed="2" AlphaStart="0.95" AlphaEnd="0.55"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0609}}<syntaxhighlight lang="xml"><AlphaAnim Anchor="C,C" Offset="0,0" Size="80.80" TextureOffset="0.0" Texture="assets\UI\Art\Icons\Resources640.dds" Pause="0" Cycle="Bounce" Speed="1" AlphaStart=".5" AlphaEnd="1" ID="ResourceImage"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0685}}<syntaxhighlight lang="xml"><AlphaAnim Anchor="C,C" Offset="0,0" Size="80.80" TextureOffset="0.0" Texture="assets\UI\Art\NotificationTradeRouteGlow80.dds" Pause="0" Cycle="Bounce" Speed="1" AlphaStart="0" AlphaEnd="1"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|TechTree.xml (G&K)}}
:<code>DLC/Expansion/UI/InGame/TechTree/TechTree.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0081}}<syntaxhighlight lang="xml"><AlphaAnim  Anchor="L,C"  AnchorSide="O.O"  Offset="-1,0" Size="16,32" TextureOffset="0.0" Texture="Assets/UI/Art/Controls/buttonsidesglowgold.dds" Pause="0" Cycle="Bounce" Speed="1" AlphaStart=".99" AlphaEnd=".25" Hidden="0"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|UnitList.xml}}
:<code>UI/InGame/UnitList.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0100}}<syntaxhighlight lang="xml"><AlphaAnim Anchor="L,C" Size="60,32" Pause="0" Cycle="Bounce" Speed="1" AlphaStart="2" AlphaEnd="1"></syntaxhighlight>
{{CodeEnd5}}
