...
=Source code samples=
''Too many occurences. Only 10 out of 262 are listed.''

{{PseudoH4|AdvisorInfoPopup.xml}}
:<code>UI/InGame/Popups/AdvisorInfoPopup.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0071}}<syntaxhighlight lang="xml"><ScrollBar  Style="VertSlider"     Offset="0,18" Anchor="R,T" AnchorSide="O,I" Length="180" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0277}}<syntaxhighlight lang="xml"><ScrollBar Offset="0.0" Style="VertSlider" Anchor="L,C" AnchorSide="O,I" Length="360" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0045}}<syntaxhighlight lang="xml"><ScrollBar Style="VertSlider" Length="364" Offset="0.18" Anchor="R,T" AnchorSide="O,I"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0164}}<syntaxhighlight lang="xml"><ScrollBar Offset="7.0" Style="VertSlider" Anchor="L,C" AnchorSide="O,I" Length="256" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|DiscussionDialog.xml}}
:<code>UI/InGame/LeaderHead/DiscussionDialog.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0063}}<syntaxhighlight lang="xml"><ScrollBar Offset="-25,20" Style="VertSlider" Anchor="R,T" Length="182" ID="ScrollBar"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0179}}<syntaxhighlight lang="xml"><ScrollBar  Anchor="R,C" AnchorSide="O,I" Length="104" Offset="0,0" Style="VertSlider"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|MedievalScenarioLoadScreen.xml (G&K)}}
:<code>DLC/Expansion/Scenarios/MedievalScenario/MedievalScenarioLoadScreen.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0163}}<syntaxhighlight lang="xml"><ScrollBar Style="VertSlider" Length="190" Offset="0.18" Anchor="R,T" AnchorSide="O,I"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|MongolScenarioLoadScreen.xml - DLC_01 DLC}}
:<code>DLC/DLC_01/Scenarios/Mongol Scenario/MongolScenarioLoadScreen.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0061}}<syntaxhighlight lang="xml"><ScrollBar Style="VertSlider" Length="432" Offset="0.18" Anchor="R,T" AnchorSide="O,I" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0009}}<syntaxhighlight lang="xml"><ScrollBar  Offset="0,0" Style="VertSlider"      Anchor="R,C"   AnchorSide="o,i"    ID="ScrollBar"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0128}}<syntaxhighlight lang="xml"><ScrollBar Offset="0,0" Style="VertSlider" Anchor="L,T" Length="255" ID="ScrollBar"/></syntaxhighlight>
{{CodeEnd5}}
