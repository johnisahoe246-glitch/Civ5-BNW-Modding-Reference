...
=Source code samples=
''Too many occurences. Only 10 out of 2068 are listed.''

{{PseudoH4|AdvancedSetup.xml}}
:<code>UI/FrontEnd/GameSetup/AdvancedSetup.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0165}}<syntaxhighlight lang="xml"><Box Size="412,74" Offset="17,71" Anchor="L,T" Color="Black.128" ID="HumanGrid" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0143}}<syntaxhighlight lang="xml"><Box Anchor="C,C" Offset="0,0" Size="398,22" Color="0,0,0,255"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0023}}<syntaxhighlight lang="xml"><Box  Anchor="C,C" AnchorSide="o,o" Offset="0,0" Size="2,160" Color="255,255,200,32" HideBox="0" ID="DetailsSeperator" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0171}}<syntaxhighlight lang="xml"><Box Anchor="L,B" Size="166,128" Offset="244,0" Color="PlayerColor2,200" Hidden="1" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|LoadReplayMenu.xml}}
:<code>UI/FrontEnd/LoadReplayMenu.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0066}}<syntaxhighlight lang="xml"><Box Anchor="R,T" Offset="48,102" Size="490,404" Color="255,255,255,0" ></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|MainMenu.xml}}
:<code>UI/FrontEnd/MainMenu.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0009}}<syntaxhighlight lang="xml"><Box Color="Black.200" Anchor="C,T" Offset="0.44" Size="320.393" Hidden="0" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0034}}<syntaxhighlight lang="xml"><Box Offset="-12,0" Anchor="L,T" Size="424,32" Color="White.0"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0018}}<syntaxhighlight lang="xml"><Box Size="200,30" Color="0,0,0,128" ID="TeamBox"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0071}}<syntaxhighlight lang="xml"><Box ID="MessagesPanel" Offset="0,35" Color="0,0,0,0" Size="920,405" Hidden="1"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|SteampunkScenarioLoadScreen.xml (G&K)}}
:<code>DLC/Expansion/Scenarios/SteampunkScenario/SteampunkScenarioLoadScreen.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0111}}<syntaxhighlight lang="xml"><Box Anchor="L,T" Offset="38,155" Size="354,80" Color="255,255,255,0" ID="MapSelectionBox"></syntaxhighlight>
{{CodeEnd5}}
