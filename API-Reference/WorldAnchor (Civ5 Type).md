...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of WorldAnchor.<br/>
...
|width="100%" |<code>{{FuncLabel5|UIElement|SetHexPosition}}<b>(</b>'''int''' plotX, '''int''' plotY<b>)</b></code>
<!-- 
SETWORLDPOSITION
-->
|-
{{FuncInfos5|yes  |yes  |no |<!-- No comment -->}}
|align="right"  |<code><!-- No return type --></code>
|width="100%" |<code>{{FuncLabel5|UIElement|SetWorldPosition}}<b>(</b>{{Type5|Vector3}} worldPos<b>)</b></code>
<!-- 
SETWORLDPOSITIONVAL
-->
|-
{{FuncInfos5|yes  |yes  |no |<!-- No comment -->}}
|align="right"  |<code><!-- No return type --></code>
|width="100%" |<code>{{FuncLabel5|UIElement|SetWorldPositionVal}}<b>(</b>'''int''' worldPosX, '''int''' worldPosY, '''int''' worldPosZ<b>)</b></code>
|}
...
:{{CodeBegin5}}
{{CodeLine5|0008}}<syntaxhighlight lang="xml"><WorldAnchor ID="Anchor" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0284}}<syntaxhighlight lang="xml"><WorldAnchor ID="BuyPlotButtonAnchor"></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0325}}<syntaxhighlight lang="xml"><WorldAnchor ID="PlotButtonAnchor"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0106}}<syntaxhighlight lang="xml"><WorldAnchor ID="Anchor" Anchor="c,c" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0085}}<syntaxhighlight lang="xml"><WorldAnchor ID="Anchor" Anchor="c,c"></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|ResourceIconManager.xml}}
:<code>UI/InGame/ResourceIconManager.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0007}}<syntaxhighlight lang="xml"><WorldAnchor ID="Anchor"></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0013}}<syntaxhighlight lang="xml"><WorldAnchor ID="Anchor" Scaling="True" DepthAdjust="-25" ></syntaxhighlight>
{{CodeEnd5}}
...
{{Civ5 API Footer}}
[[Category:Civ5 Types|WorldAnchor]]