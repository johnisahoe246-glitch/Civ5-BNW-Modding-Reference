...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of EditBox.<br/>
...
|width="100%" |<code>{{FuncLabel5|UIElement|ClearString}}<b>(</b><!-- No arguments --><b>)</b></code>
<!-- 
TAKEFOCUS
-->
|-
{{FuncInfos5|yes  |yes  |no |<!-- No comment -->}}
|align="right"  |<code><!-- No return type --></code>
|width="100%" |<code>{{FuncLabel5|UIElement|TakeFocus}}<b>(</b><!-- No arguments --><b>)</b></code>
<!-- 
SETVOID2
-->
|-
...
=Source code samples=
''Too many occurences. Only 10 out of 68 are listed.''

{{PseudoH4|AdvancedSetup.xml}}
:<code>UI/FrontEnd/GameSetup/AdvancedSetup.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0149}}<syntaxhighlight lang="xml"><EditBox Size="30,18" Anchor="L,C" ID="MaxTurnsEdit" Font="TwCenMT14" NumberInput="1" MaxLength="3" CallOnChar="1" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|ChangePassword.xml}}
:<code>UI/InGame/ChangePassword.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0025}}<syntaxhighlight lang="xml"><EditBox CallOnChar="1" EditMode="0" Size="240,22" Anchor="C,C" ID="OldPasswordEditBox" Font="TwCenMT20" MaxLength="32" Obscure="1" FocusStop="0"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0144}}<syntaxhighlight lang="xml"><EditBox EditMode="1" Size="396,20" Anchor="C,C" Font="TwCenMT20" MaxLength="16" ID="NewName"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|DiploCorner.xml}}
:<code>UI/InGame/WorldView/DiploCorner.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0029}}<syntaxhighlight lang="xml"><EditBox Offset="1,0" MaxLength="255" Size="364,16" Anchor="C,C" Font="TwCenMT14" ID="ChatEntry" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|DiploTrade.xml}}
:<code>UI/InGame/LeaderHead/DiploTrade.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0281}}<syntaxhighlight lang="xml"><EditBox EditMode="1" Size="36,16" Anchor="C,C" Font="TwCenMT14" NumberInput="1" MaxLength="4" ID="ThemGoldPerTurnAmount" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|MPGameSetupScreen.xml}}
:<code>UI/FrontEnd/Multiplayer/GameSetup/MPGameSetupScreen.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0171}}<syntaxhighlight lang="xml"><EditBox CallOnChar="1" Size="224,22" Anchor="C,C" Font="TwCenMT22"  ID="NameBox" MaxLength="16" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0132}}<syntaxhighlight lang="xml"><EditBox EditMode="1" Size="30,18" Anchor="C,C" ID="AutosaveMaxEdit" Font="TwCenMT14" NumberInput="1" MaxLength="3" /></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|PlayerChange.xml}}
:<code>UI/InGame/PlayerChange.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0030}}<syntaxhighlight lang="xml"><EditBox CallOnChar="1" EditMode="0" Size="240,22" Anchor="C,C" ID="EnterPasswordEditBox" Font="TwCenMT20" MaxLength="32" Obscure="1"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|SetCivNames.xml}}
:<code>UI/FrontEnd/GameSetup/SetCivNames.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0044}}<syntaxhighlight lang="xml"><EditBox CallOnChar="1" EditMode="1" Size="284,22" Anchor="C,C" ID="EditCivShortName" Font="TwCenMT20" MaxLength="15" FocusStop="3"/></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0052}}<syntaxhighlight lang="xml"><EditBox CallOnChar="1" EditMode="1" Size="284,22" Anchor="C,C" ID="EditCivAdjective" Font="TwCenMT20" MaxLength="15" FocusStop="4"/></syntaxhighlight>
{{CodeEnd5}}
