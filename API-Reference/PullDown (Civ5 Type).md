...
{{PseudoH4|ScrollThreshold}}
:Format: Unknown.
:Usage: Unknown.


{{PseudoH4|SpaceForScroll}}
:Format: Unknown.
:Usage: Unknown.


=New Instance Methods=
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of PullDown.<br/>
...
|width="100%" |<code>{{FuncLabel5|UIElement|GetGrid}}<b>(</b><!-- No arguments --><b>)</b></code>
|}
...
=Source code samples=
''Too many occurences. Only 10 out of 113 are listed.''

{{PseudoH4|AdvancedSetup.xml}}
:<code>UI/FrontEnd/GameSetup/AdvancedSetup.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0116}}<syntaxhighlight lang="xml"><PullDown Style="GenericPullDown" ScrollThreshold="400" Offset="150,0" Size="300,27" SpaceForScroll="0" ID="GameSpeedPullDown"/></syntaxhighlight>
{{CodeEnd5}}


{{PseudoH4|AdvancedSetup.xml (G&K)}}
:<code>DLC/Expansion/UI/FrontEnd/GameSetup/AdvancedSetup.xml</code>
:{{CodeBegin5}}
{{CodeLine5|0185}}<syntaxhighlight lang="xml"><PullDown ID="TeamPullDown" Anchor="L,T" Style="GenericPullDown" ScrollThreshold="110" Size="160,27" AutoSizePopUp="1" SpaceForScroll="1" Offset="118,34" ></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0197}}<syntaxhighlight lang="xml"><PullDown  Hidden="0" Anchor="L,B" Style="GenericPullDown" ScrollThreshold="400" Size="289,27" AutoSizePopUp="1" SpaceForScroll="0" ID="CivPulldown" Offset="0,0" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0071}}<syntaxhighlight lang="xml"><PullDown  Anchor="C,T" Style="GenericPullDown" ScrollThreshold="110" Size="290,27" AutoSizePopUp="1" SpaceForScroll="1" Offset="0,-35" ID="SortByPullDown" /></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0030}}<syntaxhighlight lang="xml"><PullDown Style="GenericPullDown" ScrollThreshold="256" Offset="0,5" Size="210,27" SpaceForScroll="0" ID="IconDropDown"/></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0155}}<syntaxhighlight lang="xml"><PullDown Style="GenericPullDown" ScrollThreshold="200" SpaceForScroll="0" Size="230,32" ID="SpokenLanguagePull" ></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0168}}<syntaxhighlight lang="xml"><PullDown Style="GenericPullDown" ScrollThreshold="200" SpaceForScroll="0" Size="210,32" ID="FSResolutionPull" ></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0174}}<syntaxhighlight lang="xml"><PullDown Style="GenericPullDown" Anchor="R,T" Offset="0,4" ScrollThreshold="200" SpaceForScroll="0" Size="130,32" ID="MSAAPull" Hidden="0" ></syntaxhighlight>
{{CodeEnd5}}
...
:{{CodeBegin5}}
{{CodeLine5|0057}}<syntaxhighlight lang="xml"><PullDown Anchor="L,C" Style="GenericPullDown" ScrollThreshold="400" Size="128,27" AutoSizePopUp="1" SpaceForScroll="0" ID="TeamPulldown" Offset="0,0" /></syntaxhighlight>
{{CodeBreak5}}
{{CodeLine5|0201}}<syntaxhighlight lang="xml"><PullDown Anchor="C,C" Style="GenericPullDown" ScrollThreshold="400" Size="128,27" AutoSizePopUp="1" SpaceForScroll="0" ID="TeamPulldown" Offset="0,0" /></syntaxhighlight>
{{CodeEnd5}}
