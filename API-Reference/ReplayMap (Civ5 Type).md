...
Methods are functions that belong to an object. Instance methods are invoked through a colon, as in <code>caller:SomeMethod(&lt;args&gt;)</code>, where ''caller'' is an instance of ReplayMap.<br/>
...
|width="100%" |<code>{{FuncLabel5|UIElement|SetMapSize}}<b>(</b>'''int''' mapWidth, '''int''' mapHeight, '''int''' arg2, '''int''' arg3<b>)</b></code>
<!-- 
SETPLOT
-->
|-
{{FuncInfos5|yes  |yes  |no |<!-- No comment -->}}
|align="right"  |<code><!-- No return type --></code>
|width="100%" |<code>{{FuncLabel5|UIElement|SetPlot}}<b>(</b>'''int''' x, '''int''' y, {{Type5|TerrainType}} terrain, '''int''' r, '''int''' g, '''int''' b, '''int''' a<b>)</b></code>
|}
...
:{{CodeBegin5}}
{{CodeLine5|0224}}<syntaxhighlight lang="xml"><ReplayMap ID="ReplayMap" Anchor="L,T" Offset="0,0" Size="920,360" /></syntaxhighlight>
{{CodeEnd5}}
