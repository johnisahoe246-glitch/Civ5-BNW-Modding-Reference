...
=Usage=
<code>'''void''' FeatureGenerator:AddJunglesAtPlot<b>(</b>{{Type5|Plot}} plot, '''int''' x, '''int''' y, '''int''' lat<b>)</b></code>
...
|valign="top"| ''No description available.''
|-
|valign="top" style="padding-right:6px;"|lat:
|valign="top"| ''No description available.''
|}


{{Civ5 API Footer}}
[[Category:Civ5 Methods and Functions|AddJunglesAtPlot]]